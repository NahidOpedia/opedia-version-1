...
export default function Navbar({trainings,categories}) {
...
const [navActive, navSetActive] = useState(false)
 ...
 const router = useRouter();
  ...
  // axios.get(`${server}/api/cat-to-service`).then(response=> setCategories(response.data));
  // axios.get(`${server}/api/course`).then(response=> setTrainings(response.data));
          ...
          <div className="row justify-content-center">
              ...
              <ul className="social-info text-center text-md-start">
                <li>
                  <a
                    ...
                    href="mailto: business@opediatech.com"
                  >
            ...
            <div className="col-md-4">
              <ul className="social text-center text-md-end">
                <li>
                  <a target="_blank" rel="noreferrer" href="https://www.facebook.com/Opediatech/">
                    <FaFacebookF />
                  </a>
                </li>
                ...
                <li>
                  <a target="_blank" rel="noreferrer" href="https://twitter.com/opedia_tech">
                    <FaTwitter />
                  </a>
                </li>
                <li>
      ...
      >
        ...
        <div className=" offset-2 col-8">
                    <div className="contact-right-form mt-5 mt-lg-0 ">
                      <h3 className="contact-modal">Get A free Quote    <span onClick={handleClose}> <FaRegTimesCircle/></span> </h3>
