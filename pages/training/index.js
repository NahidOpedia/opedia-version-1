...
export default function Training({ courses }) {
  ...
  return (
    <>
      <Meta seo_title="Advanced IT Training Institute for Skill Development" description='Advanced IT training institute for IT career growth in local, global and freelancing marketplace. Get skilled in professional courses and earn.' />
      <WhatsappChat />
      <div className="portfolio-area ">
        <div className="container mt-50">
          ...
          >
            ...
            courses?.map((course) => {
              return (
                <TrainingItem key={course.id} course={course}/>
              )
            }):
